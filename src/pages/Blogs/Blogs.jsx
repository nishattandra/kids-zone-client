...
const Blogs = () => {
    ...
    return (
        <div>
            <div className="card max-w-7xl  shadow-xl mx-auto  my-5">
                <div className="card-body border-2  border-orange-400 rounded-xl">
            ...
            <div className="card max-w-7xl  shadow-xl mx-auto">
                <div className="card-body border-2  border-orange-400 rounded-xl my-5">
